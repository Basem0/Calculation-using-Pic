...
# 14 "./ECU_Layer/Led/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 43 "./ECU_Layer/Button/ecu_button.h"
Std_ReturnType button_initialize(const button_t *btn);
# 53 "./ECU_Layer/Button/ecu_button.h"
...
# 29 "./ECU_Layer/KeyPad/ecu_keypad.h"
typedef struct{
    pin_config_t keypad_row_pins[4];
    pin_config_t keypad_columns_pins[6];
}keypad_t;
...
# 1 "./ECU_Layer/../Algorithms/Infix_to_postfix/infix_to_post.h" 1
# 14 "./ECU_Layer/../Algorithms/Infix_to_postfix/infix_to_post.h"
...
# 15 "./ECU_Layer/../Algorithms/Infix_to_postfix/infix_to_post.h" 2
...
float result;
uint8_t arr[11];
uint8_t start_flag = 0, flag = 0, pos = 1, res_counter = 0, equal_flag = 0;
uint8_t op[2] = "\0";
uint8_t operators[8] = {'/', 'E', '*', '-', '+', '=', 'D', 'C'};
uint32_t num_1 = 0;
...
Std_ReturnType calculation_start(uint8_t *value);
...
int main() {
    ...
    while (1) {
        ...
        if (val == 'A' && start_flag == 0) {
            ...
            val = '#';
            ret = lcd_4bit_send_command(&my_lcd, 0X01);
            memset(infix, '\0', 100);
        ...
        if (flag == 1 && calcState == STATE_END) {
            ...
            lcd_4bit_send_command(&my_lcd, 0X01);
            memset(infix, '\0', 100);
            memset(postfix, '\0', 100);
            res_counter = 0;
...
Std_ReturnType calculation_start(uint8_t *value) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    *value = '#';
    ret = lcd_4bit_send_string_pos(&my_lcd, 1, 1, (uint8_t *)"Basem");
