...
# 14 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
...
# 37 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    GPIO_LOW = 0,
    GPIO_HIGH
}logic_t;
...
Std_ReturnType dc_motor_initialize(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        gpio_pin_intialize(&(_dc_motor->dc_motor_pin[0x01U]));
    }
    return ret;
}
...
Std_ReturnType dc_motor_move_right(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x01U]), GPIO_LOW);
    }
    return ret;
}
...
Std_ReturnType dc_motor_move_left(const dc_motor_t *_dc_motor){
    ...
    if(((void*)0) == _dc_motor){
        ...
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x01U]), GPIO_HIGH);
    }
    return ret;
}
