...
# 19 "ECU_Layer/KeyPad/ecu_keypad.c"
static const uint8 btn_values[4][6] = {
    {'A','7', '8', '9', '*','/'},
    {'B','4', '5', '6', '-','E'},
    {'C','1', '2', '3', '+','F'},
    {'D','0', '.', '=', '+','G'}
};
# 34 "ECU_Layer/KeyPad/ecu_keypad.c"
Std_ReturnType keypad_initialize(const keypad_t *_keypad_obj){
    ...
    if(((void*)0) == _keypad_obj){
        ...
        for(columns_counter=0; columns_counter<6; columns_counter++){
            ret = gpio_pin_direction_intialize(&(_keypad_obj->keypad_columns_pins[columns_counter]));
        }
    }
    return ret;
}
# 59 "ECU_Layer/KeyPad/ecu_keypad.c"
Std_ReturnType keypad_get_value(const keypad_t *_keypad_obj, uint8 *value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    ...
    if((((void*)0) == _keypad_obj) || (((void*)0) == value)){
        ...
        for(l_rows_counter=0; l_rows_counter<4; l_rows_counter++){
            ...
            for(l_columns_counter=0; l_columns_counter<6; l_columns_counter++){
