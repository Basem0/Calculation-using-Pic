...
keypad_t pad1 = {
    ...
    .keypad_columns_pins[4].port = PORTC_INDEX,
    .keypad_columns_pins[4].pin = GPIO_PIN6,
    .keypad_columns_pins[4].direction = GPIO_DIRECTION_INPUT,
    .keypad_columns_pins[4].logic = GPIO_LOW,
    .keypad_columns_pins[5].port = PORTC_INDEX,
    .keypad_columns_pins[5].pin = GPIO_PIN7,
...
void ecu_layer_intialize(void){
    ...
    ret = lcd_4bit_intialize(&my_lcd);
    ret = keypad_initialize(&pad1);
